    ...
    withProgress(message = 'Start analysis:', value = 0, { 
      ...
      if (is.logical(result)) {
        ...
        output$myHeatmap  <- renderPlot(
          {
            pheatmap(result[[1]], angle_col = c("0"), fontsize_col = 12 ,fontsize = 9,cluster_cols = FALSE)
          }
        )
                 ...
                 tabPanel(title='Data Analysis',
                          sidebarLayout(
                            ...
                            sidebarPanel(
                              ...
                              hr(),
                              h3("Step 2: See the boxplot for COVID-19 Disease Map genes"),
                              h5("*In this step, you can check the expression of the COVID-19 Disease Map genes you are interested in!"),
                              selectInput("GeneSymbol", "Enter a COVID-19 Disease Map gene to see the boxplot", choices = c(
